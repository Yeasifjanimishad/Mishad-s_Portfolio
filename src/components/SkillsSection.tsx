            ...
            const theme = [
              {
                ...
                iconBg: 'bg-amber-100/80 dark:bg-amber-500/15 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-500/30',
                bgGlow: 'from-amber-500/15 via-orange-500/10 to-transparent',
                badgeHover: 'hover:border-amber-500/50 hover:bg-amber-100 dark:hover:bg-amber-500/20 hover:text-amber-800 dark:hover:text-amber-200',
              ...
              },
              {
                ...
                iconBg: 'bg-purple-100/80 dark:bg-purple-500/15 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-500/30',
                bgGlow: 'from-purple-500/15 via-pink-500/10 to-transparent',
                badgeHover: 'hover:border-purple-500/50 hover:bg-purple-100 dark:hover:bg-purple-500/20 hover:text-purple-800 dark:hover:text-purple-200',
              ...
              },
              {
                ...
                iconBg: 'bg-cyan-100/80 dark:bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border-cyan-200 dark:border-cyan-500/30',
                bgGlow: 'from-cyan-500/15 via-sky-500/10 to-transparent',
                badgeHover: 'hover:border-cyan-500/50 hover:bg-cyan-100 dark:hover:bg-cyan-500/20 hover:text-cyan-800 dark:hover:text-cyan-200',
                dotColor: 'text-cyan-600 dark:text-cyan-400',
              },
            ][idx % 3];
